...
# 1. Add global_drag implementation if it's missing
...
# 2. Add zstack inside pull_to_refresh
content = re.sub(
...
# 3. Add on_drag at the end of render
content = re.sub(
    r"    \}\)\n    \.grow\(\)\n\}",
    r"""    })
    )) // close zstack
...
# 4. Remove pager_drag and summary_drag calls from week_view and summary_view
